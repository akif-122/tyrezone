    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="form-group">
                ...
                <input type="text" name="fuel" class="form-control" placeholder="Fuel Efficiency" required>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="form-group">
                ...
                <input type="text" name="wet_grip" class="form-control" placeholder="Wet Grip" required>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="form-group">
                ...
                <input type="text" name="road_noise" class="form-control" placeholder="Road Noise" required>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="form-group">
                ...
                <input type="text" name="type" class="form-control" placeholder="Tyre Type" value="Car" required>
            </div>
        </div>
        ...
        <div class="col-md-5 mb-4">
            ...
            <div class="">
                <div class="form-check form-check-inline mt-2">
                    ...
                    <input type="radio" class="form-check-input" name="season" value="2" id="winter" required>
                </div>

                <div class="form-check form-check-inline mt-2">
                    <label for="summer" class="form-check-label">Summer</label>
                    <input type="radio" class="form-check-input" name="season" value="1" id="summer" required>
                </div>

                <div class="form-check form-check-inline mt-2">
                    <label for="all" class="form-check-label">All Season</label>
                    <input type="radio" class="form-check-input" name="season" value="0" id="all" required>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-3">
            ...
            <div class="form-check mt-2">
                <input id="budget" type="checkbox" name="budget" value="1" class="form-check-input">
