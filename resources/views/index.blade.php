...
<div class="main-hero">
    ...
    <div class="bg-slider owl-carousel owl-theme">
        <div class="bg-slide-img slide1" style="background-image: url(assets/imgs/hero-slides/Website-banner.jpg);">
        </div>
        <div class="bg-slide-img slide2" style="background-image: url(assets/imgs/hero-slides/Website-banner-2.jpg);">
        </div>
    </div>
    <!-- HERO BG SLIDER END -->
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-12">
                                <div class="size" style="height: auto;">
                                    ...
                                    <form method="GET" action="{{ route('filter.sizes') }}">
                                        <div class="row">
                                            <!-- Width -->
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="width" class="form-select" required="">
                                                        <option value="" selected="" style="display:none">
                                                            Select</option>
                                                        @foreach ($data->unique('width') as $size)
                                                            @if ($size->width)
                                                                <option value="{{ $size->width }}">{{ $size->width }}
                                                                </option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="profile" class="form-select" required="">
                                                        <option value="" selected="" style="display:none">
                                                            Select</option>
                                                        @foreach ($data->unique('profile') as $size)
                                                            @if ($size->profile)
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="rim_size" class="form-select" required="">
                                                        <option value="" selected="" style="display:none">
                                                            Select</option>
                                                        @foreach ($data->unique('rim_size') as $size)
                                                            @if ($size->rim_size)
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="speed" class="form-select">
                                                        <option value="" selected="" style="display:none">
                                                            Select</option>
                                                        @foreach ($data->unique('speed') as $size)
                                                            @if ($size->speed)
                                                                <option value="{{ $size->speed }}">{{ $size->speed }}
                                                                </option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-12 mt-3">
                                                <button type="submit" class="main-btn w-100">Search</button>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <div id="results" class="mt-3">
                                        @if (isset($filteredProducts) && $filteredProducts->isEmpty())
                                            ...
                                            <ul>
                                                @foreach ($filteredProducts as $product)
                                                    <li>
                                                        ...
                                                        <strong>Manufacturer:</strong> {{ $product->manu_name }}<br>
                                ...
                                <!-- Display Results -->
                                <div id="results" class="mt-3">
                                    @if (isset($filteredSizes) && $filteredSizes->isEmpty())
                                        <p>No results found.</p>
                                    @elseif(isset($filteredSizes))
                                        <ul>
                                            @foreach ($filteredSizes as $size)
                                                <li>
                                                    ...
                                                    {{ $size->manufacturer_name }}<br>
                                                    <strong>Pattern Type:</strong> {{ $size->tyre_pattern }}<br>
                                                    <strong>Tyre Type:</strong> {{ $size->tyre_type }}<br>
                                                    <strong>Season:</strong> {{ $size->season }}<br>
                                                    <strong>Price:</strong> ${{ number_format($size->price, 2) }}<br>
                                                    <strong>Budget:</strong>
                                                    {{ $size->budget_tyres ? 'Yes' : 'No' }}<br>
                                                </li>
                                            @endforeach
